...
#-- execute request
request = ""
response = urllib.urlretrieve(request)
...
for xmlob in xmlobs:
    obs.append(om_Observation(xmlob))
...
for idx,ob in enumerate(obs):
    ...
    zooNames.append("%s" %ob.procedure) = r('%s<-zoo(data_f,data_i)'%(ob.procedure))
